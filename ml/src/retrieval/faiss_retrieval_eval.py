...
class FaissRetriever:
    def __init__(self, dim=384, model_name="sentence-transformers/all-MiniLM-L6-v2"):
    ...
    def build_index(self, job_texts, job_ids=None):
        """
        job_texts: list[str] - mô tả công việc
        job_ids: list[str] - id hoặc tên job
        """
    ...
    def search(self, query, topk=5):
        """
        query: str - CV ứng viên hoặc đoạn văn bản
        """
